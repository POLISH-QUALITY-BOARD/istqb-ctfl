# Testovacie nástroje – 20 minút {#test-tools}
...
2. Prínosy a riziká automatizácie testov
    1. (K1) Zapamätať si prínosy a riziká automatizácie testov.
...
* nástroje pre manažment testovania – zvyšujú efektivitu testovacieho procesu uľahčením správy SDLC, požiadaviek, testov, defektov, konfigurácií,
