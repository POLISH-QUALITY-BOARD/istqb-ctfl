# Podstawy testowania – 180 minut {#fundamentals-of-testing}
...
1. Co to jest testowanie?
    ...
    2. (K2) Odróżniać testowanie od debugowania.
2. Dlaczego testowanie jest niezbędne?
    1. (K2) Podać przykłady wskazujące, dlaczego testowanie jest niezbędne.
    2. (K1) Pamiętać, jaka jest relacja między testowaniem a zapewnieniem jakości.
    3. (K2) Odróżniać podstawową przyczynę, pomyłkę, defekt i awarię.
3. Zasady testowania
    1. (K2) Objaśnić siedem zasad testowania.
4. Czynności testowe, testalia i role związane z testami
    1. (K2) Wyjaśnić poszczególne czynności testowe i powiązane z nimi zadania.
    2. (K2) Wyjaśnić wpływ kontekstu na proces testowy.
    3. (K2) Rozróżniać testalia wspomagające czynności testowe.
    4. (K2) Wyjaśnić korzyści wynikające ze śledzenia powiązań.
    5. (K2) Porównać poszczególne role występujące w testowaniu.
5. Niezbędne umiejętności i dobre praktyki w dziedzinie testowania
    1. (K2) Podać przykłady ogólnych umiejętności wymaganych w testowaniu.
    2. (K1) Pamiętać, jakie są zalety podejścia „cały zespół”.
    3. (K2) Odróżniać korzyści i wady niezależności testowania.
...
### Czynności i zadania testowe {#test-activities-and-tasks}
...
### Podejście „cały zespół” {#whole-team-approach}
