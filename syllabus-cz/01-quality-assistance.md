# Základy testování – 180 minut {#quality-assistance}
...
Další informace o konceptech testování softwaru lze nalézt v normě ISO/IEC/IEEE 29119-1 [@ISO29119-1].
...
Další informace o procesech testování lze nalézt v normě ISO/IEC/IEEE 29119-2 [@ISO29119-2].
...
* **Pracovní produkty z dokončení testování** : souhrnný report z testování (viz <#section:purpose-content-target-of-test-reports>), akční body pro zlepšení budoucích projektů nebo iterací, zdokumentované ponaučení (lessons learned) a změnové požadavky (např. jako položky produktového backlogu).
...
Hlavním přínosem nezávislosti testování je to, že nezávislí testeři dokáží pravděpodobněji rozpoznat různé druhy selhání a defektů ve srovnání s vývojáři, a to z důvodu jejich odlišného zázemí, technického nadhledu a předsudků. Nezávislí testeři mohou navíc ověřit, napadnout či vyvrátit předpoklady, které měly všechny zainteresované strany v době přípravy specifikace či implementace systému.
