...
## Profesní cíle {.business-outcomes}
...
1. Chápat, co je testování a proč je prospěšné. |
1. Chápat základní koncepty testování softwaru. |
1. Určit přístup k testování a činnosti, které mají být provedeny v závislosti na kontextu. |
1. Posoudit a zlepšit kvalitu dokumentace. |
1. Zvýšit efektivitu a účinnost testování. |
1. Sladit proces testování s životním cyklem vývoje softwaru. |
1. Rozumět principům managementu testování. |
1. Psát jasné a srozumitelné reporty o defektu a umět je komunikovat. |
1. Chápat faktory, které ovlivňují priority a pracnost činností souvisejících s testováním. |
1. Pracovat jako součást multifunkčního týmu. |
1. Rozumět rizikům a přínosům automatizace testů. |
1. Identifikovat nezbytné dovednosti potřebné pro testování. |
1. Chápat dopad rizik na testování. |
1. Efektivně reportovat o postupu a kvalitě testování. |
...
Na začátku každé kapitoly (těsně pod názvem kapitoly) je uveden seznam klíčových slov. Všechna uvedená klíčová slova je nutné si zapamatovat (K1), a to i v případě, že nejsou výslovně uvedena ve studijních cílech. Více informací o klasifikaci úrovní znalostí včetně příkladů lze nalézt v příloze (viz <#section:cognitive-levels>).
...
V těchto učebních osnovách jsou uvedeny odkazy na různé normy (např. normy IEEE nebo ISO). Informace v těchto normách mohou být citovány přímo (např. norma ISO 25010 při definici kvalitativních charakteristik) nebo poskytují případnému čtenáři zdroj dalších informací. Samotné normy však nejsou předmětem zkoušky. Více informací lze nalézt v <#section:references>.

## Zajištění aktuálnosti

Softwarový průmysl se dynamicky mění. Aby bylo možné se s těmito změnami vypořádat a poskytnout zainteresovaným stranám přístup k relevantním a aktuálním informacím, vytvořily pracovní skupiny ISTQB® na webových stránkách [www.istqb.org](http://www.istqb.org/) odkazy, které vedou na podpůrnou dokumentaci a změny norem. Znalost těchto informací není při zkoušce základní úrovně vyžadována.
...
| QC | quality control | riadenie kvality |
